          ...
          <section className="produto-detalhes">
            <div className="produto-detalhes-conteudo">
              ...
              <div className="info-produto">
                ...
                <div className="info-adicional">
                  <p>
                    <i className="fa fa-truck"></i> Frete grátis para compras
                    acima de R$ 200,00
                  </p>
                  <p>
                    <i className="fa fa-credit-card"></i> Até 12x sem juros
                  </p>
                  <p>
                    <i className="fa fa-shield"></i> Garantia de{" "}
                    {produto.garantia}
                  </p>
                </div>
              </div>
            ...
            <div className="abas">
              <button
                ...
                className={activeTab === "descricao" ? "ativa" : ""}
              >
                Descrição
              </button>
              <button
                onClick={() => setActiveTab("especificacoes")}
                className={activeTab === "especificacoes" ? "ativa" : ""}
              >
                Especificações
              </button>
              <button
                onClick={() => setActiveTab("avaliacoes")}
                className={activeTab === "avaliacoes" ? "ativa" : ""}
              >
                Avaliações
              </button>
            </div>
            ...
            <div className="conteudo-abas">
              {activeTab === "descricao" && (
                <div>
                  ...
                  <p>
                    <strong>Conteúdo da Embalagem:</strong> {produto.conteudo}
                  </p>
                  <p>
                    <strong>Datasheet:</strong>{" "}
                    <a
                      href={produto.datasheet}
                      target="_blank"
              ...
              {activeTab === "especificacoes" && (
                <ul>
                  {Object.entries(produto.especificacoes).map(([k, v]) => (
                    <li key={k}>
                      <strong>{formatarCampo(k)}:</strong> {v}
                    </li>
                  ))}
                </ul>
              )}
              ...
              <div className="grid-relacionados">
                {produtosRelacionados.map((p) => (
                  <div key={p.id} className="card-produto">
                    ...
                    <a className="btn-detalhes" href={`/produto/${p.id}`}>
                      Ver Detalhes
                    </a>
                  </div>
                ))}
